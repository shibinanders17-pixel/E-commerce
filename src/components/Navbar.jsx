...
//                          rounded-l-md text-sm outline-none focus:border-red-600"
//             />
//             <button className="bg-red-500 hover:bg-red-600 px-4 py-2 rounded-r-md transition">
...
//                 className="hover:ring-2 hover:ring-red-400 rounded-full transition"
//               >
//                 <Avatar size="sm" />
//               </button>
